...
![Am I Responsive](docs/PLACEHOLDER.png)
...
1. [Bootstrap 5.2.0:](https://getbootstrap.com) - Bootstrap was used to create website grid and to make it responsive. Other features used and customised: 
    * Navbar,
    * Carusel,
    * Acordion,
    * Shortcode for spacing elements (eg. px-5)
1. [Hover.css:](https://ianlunn.github.io/Hover/) - Hover.css was used on the Social Media icons in the footer to add the float transition while being hovered over.
1. [Balsamiq:](https://balsamiq.com/) - Balsamiq was used to create the [wireframes](https://github.com/) during the design process.
1. [Coolors.co](https://coolors.co/) - was used to create color palette. 
1. [Google Fonts:](https://fonts.google.com/specimen/Raleway) - Google fonts were used to import the 'Raleway' font into the style.css file which is used on all pages throughout the project.
1. [Google Maps](https://www.google.com/maps) - was used to embed map with Yoga Studio location. 
1. [YouTube](https://www.youtube.com) - was used to embed video on a website. 
...
1. [Photoshop:](https://www.adobe.com/ie/products/photoshop.html) - Photoshop was used to create the logo and resize the pictures. 
1. [BD_sizer](https://bd-sizer.en.softonic.com/) - used for resizeing pictures in the gallery.
1. [TinyPNG](https://tinypng.com/) - used for images compression.
1. [Convertio.co](https://convertio.co/jpg-webp/) - online JPG to WEBP converter. 
1. [CSS Beautifier](https://www.freeformatter.com/css-beautifier.html) - used for formatting css file for optimal readability. 
...
-   My Mentor Reuben Ferrante for helpful feedback and guidance. 

-   Site was created for educational purpose only. 